...
class User extends \yii\db\ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            [['username'], 'required'],
            [['level_id','lawyer_id','other_level'],'validate_type','skipOnEmpty'=> false],
            ['username', 'unique'],
    ...
    public function validate_type($attribute,$params){
        if(empty($this->level_id) && empty($this->lawyer_id) && empty($this->other_level)){
            $this->addError($attribute,"请选择关联律师或者级别");
            return false;
        }
        return true;
    }
